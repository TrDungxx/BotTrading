    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-dark-800 rounded-xl border border-dark-600 w-full max-w-md mx-4 shadow-2xl">
        ...
        <div className="flex items-center justify-between p-4 border-b border-dark-700">
          <h3 className="text-base font-semibold text-white">Đơn vị tạo lệnh</h3>
          <button
            onClick={onClose}
        ...
        <div className="p-4 space-y-3">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <div className="text-white font-semibold text-base">{baseAsset}</div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <div className="text-white font-semibold text-base">USDT</div>
                <div className="text-dark-400 text-sm mt-1">
                ...
                <div className="flex items-center gap-3 mt-3">
                  <label className="flex items-center space-x-2 cursor-pointer">
                    ...
                    />
                    <span className="text-white text-sm">Quy mô lệnh</span>
                  </label>
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="radio"
                      ...
                      onClick={(e) => e.stopPropagation()}
                    />
                    <span className="text-white text-sm">Ký quỹ ban đầu</span>
                  </label>
                </div>
              </div>
              {selectedUnit === "quote" && (
        ...
        <div className="px-4 pb-4">
          <div className="flex items-start gap-2 p-3 bg-dark-900/50 rounded-lg border border-dark-700">
