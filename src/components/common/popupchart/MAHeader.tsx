...
const MAHeader: React.FC<Props> = ({ maValues, visible, onToggleVisible, onOpenSetting, onClose }) => {
  ...
  return (
    <div className="absolute top-fluid-2 left-2 bg-dark-800/90 rounded-fluid-md px-2 py-fluid-1 text-xs z-20">
      <div className="flex items-center gap-fluid-2">
        ...
        {!isFolded && (
          <>
            {maValues.map((ma, i) => (
              <div key={i} className="flex items-center gap-fluid-1">
            ...
            {/* Buttons */}
            <div className="flex items-center gap-fluid-2 ml-4">
