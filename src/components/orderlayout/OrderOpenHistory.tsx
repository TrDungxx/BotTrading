  ...
  return (
    <div className="flex-1 border-r border-dark-700">
      <div className="flex items-center justify-between p-fluid-3 border-b border-dark-700">
        <h3 className="text-fluid-sm font-medium">Order History</h3>
        <button className="text-xs text-dark-400 hover:text-dark-200">View All</button>
      </div>

      <div className="p-fluid-4 text-center text-dark-400">
        <div className="text-fluid-sm">No order history</div>
