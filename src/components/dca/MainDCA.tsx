    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-fluid-4">
      ...
      <div>
        ...
        <button className="form-input w-full flex items-center justify-between min-w-0">
          <div className="flex items-center gap-fluid-2 truncate">
            <div className="size-6 rounded-full bg-dark-700 grid place-content-center text-fluid-2xs">★</div>
      ...
      <div className="md:col-span-2">
        <button className="text-primary text-fluid-sm underline underline-offset-4">Market data insight</button>
      </div>
    </div>
  );
};
