  ...
  return (
    <div className="overflow-x-auto">
      <table className="min-w-full divide-y divide-dark-700">
        <thead>
          <tr>
            <th className="py-3.5 pl-4 pr-3 text-left text-xs font-medium text-dark-400 sm:pl-0">Bot</th>
            <th className="px-3 py-3.5 text-left text-xs font-medium text-dark-400">Pair</th>
            <th className="px-3 py-3.5 text-right text-xs font-medium text-dark-400">Today</th>
            <th className="px-3 py-3.5 text-right text-xs font-medium text-dark-400">Total</th>
            <th className="px-3 py-3.5 text-center text-xs font-medium text-dark-400">Status</th>
            ...
            <tr key={bot.id} className="hover:bg-dark-700/40">
              <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-0">
                <div className="flex items-center">
                  <div className="h-8 w-8 flex-shrink-0 rounded-md bg-primary-500/10 flex items-center justify-center">
              ...
              <td className="whitespace-nowrap px-3 py-4 text-sm">{bot.pair}</td>
